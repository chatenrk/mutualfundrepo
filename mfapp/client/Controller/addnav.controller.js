                ...
                function(BaseController, MessageToast,UploadCollectionParameter,Helpers,Moment,Export, ExportTypeCSV) {
                    ...
                    return BaseController
                            .extend(
                                    ...
                                    {
                                      // This function reads the data in the file
                                    ...
                                    _parsesuccess:function(navdata,that)
                                    {
                                      ...
                                      // Call the ajax for posting to database
                                      ...
                                      // var data = {
                                      //     title:"Post NAV Data",
                                      //     text:"Posting"+navdata.length +" NAV record(s) to database. Please wait"
                                      // }
                                      //
                                      // oJSONModel.setData(data);
                                      // this.getView().setModel(oJSONModel,"busyDialog");
                                      ...
                                      // this._dialog.open();
                                      //
                                      // var pauthurl = "http://localhost:3000/nav/navpost";
                                      // var that = this;
                                      //
                                      // // var fd = new FormData();
                                      // // fd.append('file', navdata);
                                      //
                                      // $.ajax(
                                      //         {
                                      //           url:pauthurl,
